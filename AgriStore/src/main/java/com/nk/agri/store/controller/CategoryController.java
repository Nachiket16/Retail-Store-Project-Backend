...
import com.nk.agri.store.services.CategoryService;
...
//    @PreAuthorize("hasRole('ADMIN')")
    ...
    public ResponseEntity<ApiResponseMsg> deleteCategory(
            @PathVariable String categoryId
    ) {
        categoryService.delete(categoryId);
        ApiResponseMsg responseMessage = ApiResponseMsg.builder().msg("Category is deleted successfully !!").status(HttpStatus.OK).success(true).build();
